document.addEventListener("DOMContentLoaded", function() {
    ...
    function displayFeedItems(xml, avatarUrl, username) {
      ...
      items.forEach(item => {
        ...
        const description = item.querySelector("summary") ? decodeHtml(item.querySelector("summary").textContent) : "";
        ...
        titleElement.classList.add("akkoma-title");
        titleElement.textContent = title;
  
        const descriptionElement = document.createElement("p");
        descriptionElement.classList.add("akkoma-description");
